...
namespace Ophim\ThemeAnimevsub;

use Illuminate\Foundation\Support\Providers\AuthServiceProvider as ServiceProvider;

class ThemeAnimevsubServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../resources/assets' => public_path('themes/animevsub')
        ], 'animevsub-assets');
    }
    ...
    protected function setupDefaultThemeCustomizer()
    {
        config(['themes' => array_merge(config('themes', []), [
            'animevsub' => [
                ...
                'package_name' => 'ggg3/theme-animevsub',
                'publishes' => ['animevsub-assets'],
                'preview_image' => '',
                'options' => [
                    [
