...
@section('content')
    <div id="p0" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000">
        <div class="myui-panel myui-panel-list mt-2 clearfix">
            ...
            @include('themes::themeanimevsub.inc.catalog_filter')
                    ...
                    <div class="myui-panel_bd clearfix">
                        ...
                        <div id="myui-vodlist clearfix" class="film-list" role="list">
                            @foreach ($data as $key => $movie)
                                ...
                                @include('themes::themeanimevsub.inc.catalog_sections_movies_item')
                            @endforeach

                            <div class="col-md-12">
                                <div class="d-flex justify-content-center">
                                    {{ $data->appends(request()->all())->links('themes::themeanimevsub.inc.pagination') }}
                                </div>
                            </div>
                        </div>
                    </div>
