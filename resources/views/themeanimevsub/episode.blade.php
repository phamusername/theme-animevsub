@extends('themes::themeanimevsub.layout')
...
@section('content')
    ...
    <div itemscope itemtype="http://schema.org/Movie">
        <div class="rating-block text-center">
            @include('themes::themeanimevsub.inc.rating2')
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-wide-3 col-xs-1 myui-sidebar hidden-sm hidden-xs">
                @include('themes::themeanimevsub.sidebar')
            </div>
        </div>
    </div>
...
@push('scripts')
    <script src="/themes/animevsub/static/player/skin/juicycodes.js"></script>
    <link href="/themes/animevsub/static/player/skin/juicycodes.css" rel="stylesheet" type="text/css">

    {{--    <script src="/themes/animevsub/static/player/js/p2p-media-loader-core.min.js"></script> --}}
    {{--    <script src="/themes/animevsub/static/player/js/p2p-media-loader-hlsjs.min.js"></script> --}}

    <script src="/themes/animevsub/static/player/jwplayer.js"></script>
            ...
            if (type == 'embed') {
                if (vastAds) {
                    ...
                    const objSetupFake = {
                        ...
                        aspectratio: "16:9",
                        width: "100%",
                        file: "/themes/animevsub/static/player/1s_blank.mp4",
                        volume: 100,
                        mute: false,
                        autostart: true,
                        advertising: {
