@extends('themes::themeanimevsub.layout_core')
...
@push('header')
    {{-- @if (!(new \Jenssegers\Agent\Agent())->isDesktop())
        <link rel="stylesheet" type="text/css" href="/themes/animevsub/css/ipad.css?v=1.0.5" />
    @endif --}}
    ...
    <link href="/themes/animevsub/static/css/main.css?v=5" rel="stylesheet" media="all">
...
@section('body')
    @include('themes::themeanimevsub.inc.header')
...
@section('footer')
    ...
    <script src="/themes/animevsub/efc0d744/yii.js"></script>
    <script src="/themes/animevsub/static/js/flickity.smart.min.js"></script>
    <script src="/themes/animevsub/static/js/main.js?v=4"></script>
    {{-- <script src="/themes/animevsub/js/ads_xx.js?v=7"></script> --}}
